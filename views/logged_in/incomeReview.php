...
function getForm($CategoryParentType, $CategoryParentOrder)
{
    ...
    {
        echo '<div class = "row"><div class="col-sm-5"><h5>' . $row["categoryName"] . '</h5></div><div class = "col-sm-3"><span>$&nbsp';
...
echo '<hr><div><div class="row">
                <h4 class="panel-title col-sm-5"><b>Gross Income</b></h4>
                <div class="col-sm-1"><span>$&nbsp' . $grossIncome . '</span></div>
            </div>
            
            <div class="row">
                <div class="panel-body col-sm-5"><span>Less Federal and State Income Taxes</span></div>
                <div class="col-sm-1"><span>$&nbsp' . $tax . '</span></div>
                <div class="col-sm-1"><span>' . number_format($GLOBALS['tax'] / $GLOBALS['grossIncome'] * 100) . '&nbsp%</span></div></div><hr><div class="row">';
$netIncome = $grossIncome - $tax;
echo '<h4 class="panel-title col-sm-5"><b>Net Income</b></h4><div class="col-sm-1"><span>$&nbsp' . $netIncome . '</span><hr></div>';
?>
