...
(3, 1, 'Alimony & Child Support', 'Tooltip',NULL),
(3, 2, 'Social Security Disability (SSDI)', 'Tooltip',NULL),
(3, 3, 'Supplemental Security Income (SSI)', 'Tooltip',NULL),
(3, 4, 'Federal and State tax refund', 'Tooltip',NULL),
(3, 5, 'Public Housing (Subsidized portion)', 'Tooltip',NULL),
(3, 6, 'Food Stamps', 'Tooltip',NULL),
(3, 7, 'Financial (FEP or General Assistance)', 'Tooltip',NULL),
(3, 8, 'State Childcare Assistance', 'Tooltip',NULL),
(3, 9, 'Internships with Stipend (Work study, Easter Seals, etc.)', 'Tooltip',NULL),
(3, 10, 'Other cash assistance (Training funds)', 'Tooltip',NULL),
...
(5, 4, 'Property taxes', 'Tooltip','NonMonthly'),
(5, 5, 'Repairs, improvements, and maintenance', 'Tooltip','NonMonthly'),
(5, 6, 'Power (Electricity)', 'Tooltip','NonMonthly'),
(5, 7, 'Heat', 'Tooltip','NonMonthly'),
(5, 8, 'Garbage (Sewer)', 'Tooltip','NonMonthly'),
(5, 9, 'Water', 'Tooltip','NonMonthly'),
(5, 10, 'Garbage', 'Tooltip','NonMonthly'),
(5, 11, 'Phone (Home)', 'Tooltip','NonMonthly'),
(5, 12, 'Phone (Mobile)', 'Tooltip','NonMonthly'),
(5, 13, 'Internet', 'Tooltip','NonMonthly'),
(5, 14, 'Other housing costs', 'Tooltip','NonMonthly'),
...
(7, 5, 'Vision insurance', 'Tooltip','NonMonthly'),
(7, 6, 'Prescriptions', 'Tooltip','NonMonthly'),
(7, 7, 'Co-Pays (Doctor, dentists, hospitals, specialists, etc.)', 'Tooltip','NonMonthly'),
(7, 8, 'Other medical expenses', 'Tooltip','NonMonthly'),
