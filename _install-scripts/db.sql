...
(2, 4, 'Interest and Dividend Income', 'Enter the amount you actually receive (Net amount) each month here (Would be good to have a calculator that takes annual amount and derives monthly amount).',NULL),
(3, 1, 'Alimony', 'Enter the amount you actually receive each month here, use estimates or averages if necessary.',NULL),
(3, 2, 'Child Support', 'Enter the amount you actually receive each month here, use estimates or averages if necessary',NULL),
(3, 3, 'Social Security Disability (SSDI)', 'Enter the amount you actually receive (Net amount) each month here, use estimates or averages if necessary.',NULL),
(3, 4, 'Supplemental Security Income (SSI)', 'Enter the amount you actually receive (Net amount) each month here, use estimates or averages if necessary.',NULL),
(3, 5, 'Federal and State tax refund', 'Enter the total of your typical refund from both federal and state into calculator to estimate the monthly income that your refund should create. Enter 0 if you don''t get a refund.',NULL),
(3, 6, 'Public Housing (Subsidized portion)', 'Enter the amount you actually receive (Net amount) each month here, use estimates or averages if necessary.',NULL),
(3, 7, 'Food Stamps', 'Enter the amount you actually receive (Net amount) each month here, use estimates or averages if necessary.',NULL),
(3, 8, 'Financial (FEP or General Assistance)', 'Enter the amount you actually receive (Net amount) each month here, use estimates or averages if necessary.',NULL),
(3, 9, 'State Childcare Assistance', 'Enter the amount you actually receive (Net amount) each month here, use estimates or averages if necessary.',NULL),
(3, 10, 'Internships with Stipend (Work study, Easter Seals, etc.)', 'Enter the amount you actually receive (Net amount) each month here, use estimates or averages if necessary.',NULL),
(3, 11, 'Other cash assistance (Training funds)', 'Enter the amount you actually receive (Net amount) each month here, use estimates or averages if necessary.',NULL),
...
(5, 5, 'Homeowner and Renter''s Insurance', 'Enter the amount you pay monthly for homeowner or renter''s insurance here. If you pay your homeowner''s insurance with your mortgage payment enter zero here. Use the calculator if you pay this once a year.','NonMonthly'),
...
(6, 3, 'Auto insurance', 'Enter the amount you pay each month for auto insurance. If you have more than one car and you don''t know how much is for each vehicle just put the total in the first field','NonMonthly'),
