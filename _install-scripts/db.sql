...
(3, 1, 'Alimony', 'Enter the amount you actually receive each month here, use estimates or averages if necessary.','NonMonthly'),
(3, 2, 'Child Support', 'Enter the amount you actually receive each month here, use estimates or averages if necessary','NonMonthly'),
